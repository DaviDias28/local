...
\input{Capitulo 1/capitulo1} % Adiciona  capítulo na parte 1. Para escrever o capítulo 1, abra o arquivo "/Capitulo 1/capitulo1.tex". O mesmo raciocínio vale para os demais.
\input{Capitulo 2/capitulo2}


\parte{Parte Dois}  % Comente essa linha (ctrl+/) se não quiser dividir a apostila em partes
\input{Capitulo 3/capitulo3} % Adicionar  capítulo na parte 2
%\input{Capitulo 4/capitulo4}
